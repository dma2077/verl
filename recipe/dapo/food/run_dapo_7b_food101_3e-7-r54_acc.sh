...
project_name='DAPO'
exp_name='food101_nofreeze_3e_7_r54_acc'
...
NNODES=${NNODES:-1}
# Paths
MODEL_PATH=${MODEL_PATH:-"/mmu_mllm_hdd_2/madehua/model/CKPT/food_model/Qwen2.5-VL-food101_cold_sft_nofreeze"}
...
TEST_FILE=${TEST_FILE:-"/llm_reco/dehua/data/sample_1024/food101/test.parquet"}
